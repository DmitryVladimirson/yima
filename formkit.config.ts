...
const generalClassification = {
  ...
  label: 'block text-sm',
  help: 'text-sm mt-1',
  messages: 'bg-warning py-2 px-3 rounded text-white mt-1 '
}
...
const config: DefaultConfigOptions = {
  ...
  config: {
    classes: generateClasses({
      ...
      submit: {
        input: 'bg-primary hover:bg-primary-light text-white inline-flex gap-1 items-center justify-center py-3 px-4 text-sm font-semibold uppercase rounded outline-none focus:outline-none transition-all duration-100 disabled:opacity-70 disabled:cursor-not-allowed'
      },
